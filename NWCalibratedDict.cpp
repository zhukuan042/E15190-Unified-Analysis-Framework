...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::VetoWallCalibratedData*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("VetoWallCalibratedData", ::VetoWallCalibratedData::Class_Version(), "NWCalibratedRootEvent.h", 43,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::ForwardArrayCalibratedData*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("ForwardArrayCalibratedData", ::ForwardArrayCalibratedData::Class_Version(), "NWCalibratedRootEvent.h", 70,
