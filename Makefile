...
install : $(E15190SHARED)

$(E15190SHARED): $(OBJS) $(ROOTHTNW_DICTO) $(ROOTHTVW_DICTO) $(ROOTHTFA_DICTO) $(ROOTNWCALIBRATED_DICTO) $(ROOTHTMB_DICTO) $(ROOTMBCALIBRATED_DICTO) $(ROOTHTHIRA_DICTO)
	$(CXX) $(CXXFLAGS) -shared -o $(LibDir)${@} $^ $(SYSLIB) $(CFLAGS) $(RLIBS)
	cp $(ROOTHTNW_PCM) $(ROOTHTVW_PCM) $(ROOTHTMB_PCM) $(ROOTNWCALIBRATED_PCM) $(ROOTMBCALIBRATED_PCM) $(ROOTHTHIRA_PCM) $(LibDir)
