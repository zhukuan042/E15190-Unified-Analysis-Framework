...
int main (int argc, char ** argv)
{
  ...
  {
    char file_evt[100];
    sprintf (file_evt,"CalibratedData_HiRA_%04d*.root",cur_run);
    ...
    E15190Reader E15190Analyzer(dataChain, "HiRA", 1);


    //Definition of the output file //////

    std::string FileOutName(Form("outputNW/UsefulHistograms_HiRA_%04d.root", cur_run));


    //Run the required method(s) /////////

    E15190Analyzer.CreateUsefulHiRAHistograms(FileOutName.c_str(), evt_amount);
